/* $Id: symtab.h,v 1.4 2023/03/14 23:02:38 leavens Exp $ */
#ifndef _SYMTAB_H
#define _SYMTAB_H
...
// Return the current scope's next location offset to use for allocation
// (of constants and variables).
extern unsigned int symtab_next_loc_offset();
